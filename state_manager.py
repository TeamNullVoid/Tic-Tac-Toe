...
main_screen_components = [
    ...
    Button(text_play_ai, dimen.button_text_size, dimen.button_size, colors.white, colors.red, dimen.single_pl_btn_pos),
    Button(text_play_off, dimen.button_text_size, dimen.button_size, colors.white, colors.red, dimen.multi_pl_off_pos),
    Button(text_play_on, dimen.button_text_size, dimen.button_size, colors.white, colors.red, dimen.multi_pl_on_pos),
